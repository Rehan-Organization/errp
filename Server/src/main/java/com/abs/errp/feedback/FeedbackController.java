...
public class FeedbackController {
	...
	@PreAuthorize("hasRole('SUPERVISOR')")
	public ResponseEntity<List<Feedback>> getAllFeedbacks(@PathVariable boolean isMyFeedback) {
		return ResponseEntity.ok(this.feedbackService.getMyFeedbacks(isMyFeedback));
	}
	...
	@PreAuthorize("hasRole('SUPERVISOR')")
	void removeFeedback(@PathVariable("id") Long id) {
	...
	@PreAuthorize("hasRole('SUPERVISOR')")
	Optional<Feedback> getFeedback(@PathVariable long id) {
